...
public class Test193 {
    ...
    @Test(description = "Add Fixed Asset with Account selection, Description, Amount, and Rate (Test193)")
    @Epic("Bookkeeping")
    @Feature("Assets")
    @Story("Add Fixed Asset with Account, Description, Amount, Rate")
    @Severity(SeverityLevel.CRITICAL)
    public void addFixedAssetFullDetails() {
        ...
        Allure.step("Enter asset details: Name, Account, Description, Amount, Rate", () -> {
