...
public class Test99 {
    ...
    @Test(description = "Mileage Claim - Date is mandatory")
    @Epic("Expense Claims")
    @Feature("Mileage Claims")
    @Story("User tries to save mileage claim without entering date")
    @Severity(SeverityLevel.CRITICAL)
    public void ExpenseClaims_DateMandatory_Test() {
        ...
        // Clear the date field to simulate missing date
        WebElement date = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[1]/div[1]/div/div[2]/div[1]/div[2]/div/div/div/div/div/input")));
        date.click();
        date.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        date.sendKeys(Keys.DELETE);
        Allure.step("Cleared date field (mandatory field)");
        ...
        save.click();
        Allure.step("Clicked Save button - validation should prevent saving without date");
    }
...
//            user.click();
//
//            WebElement date = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[1]/div[1]/div/div[2]/div[1]/div[2]/div/div/div/div/div/input")));
//            date.click();
//            date.sendKeys(Keys.chord(Keys.CONTROL, "a"));
//            date.sendKeys(Keys.DELETE);
//
