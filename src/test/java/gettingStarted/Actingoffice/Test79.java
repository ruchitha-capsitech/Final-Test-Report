...
public class Test79 {
    ...
    @Test(description = "Search for a journal entry")
    @Epic("Journals")
    @Feature("Search Journal")
    @Story("Search journal by number, reference, or amount")
    @Severity(SeverityLevel.NORMAL)
    public void Journal_Search_Test() {
        ...
        WebElement search = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div/div[3]/div[1]/div[2]/div[1]/input")));
        search.click();
        search.sendKeys("test1");
        search.sendKeys(Keys.ENTER);
        Allure.step("Entered search text 'test1' and submitted search");
    }
...
//
//
//            WebElement search = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div/div[3]/div[1]/div[2]/div[1]/input")));
//            search.click();
//            search.sendKeys("test1");
//            search.sendKeys(Keys.ENTER);
//        } catch (Exception e) {
...
//                "Search option",
//                "",
//                "Enter the journal number, reference, or amount to search for a specific transaction.",
//                "The matching transaction(s) will be displayed.",
//                "verified",
//                "",
//                "Tested",
//                ""
