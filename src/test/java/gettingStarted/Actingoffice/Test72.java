...
public class Test72 {
    ...
    @Test(description = "Add a new Journal and continue creating next Journal using 'Save and New'")
    @Epic("Journals")
    @Feature("Add Journal")
    @Story("Create Journal and continue to next using 'Save and New'")
    @Severity(SeverityLevel.CRITICAL)
    public void Journals_AddNewAndContinue_Test() {
        ...
        Allure.step("Clicked Add Journal");
        ...
        Allure.step("Entered Journal reference");
        ...
        WebElement saveAndNew = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//*[@id=\"root\"]/div/div/div[2]/div[2]/div/div[2]/div[2]/form/div/div[3]/table/tbody/tr[6]/td[1]/div/button[3]")));
        saveAndNew.click();
        Allure.step("Clicked 'Save and New', navigated to next Journal creation screen");
    }
...
//                "Add a new Journal",
//                "",
//                "Click on add + Journal, Date and voucher number will come auto, enter Journal reference,  Select account, Enter description if any, select VAT rate if any from dropdown, and enter amount in the respective boxes. Now click on Save and New if you want to continue to create new journals.",
//                "You will be on new Journal creation screen with next reference number and that saved on Journal dashboard with its reference number.",
//                "verified",
//                "",
//                "Tested",
//                ""
