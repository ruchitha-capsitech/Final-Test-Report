...
public class Test196 {
    ...
    @Test(description = "Add Fixed Asset with Account, Supplier, Description, and Amount (Test196)")
    @Epic("Bookkeeping")
    @Feature("Assets")
    @Story("Add Fixed Asset with basic details")
    @Severity(SeverityLevel.NORMAL)
    public void addFixedAssetBasicDetails() {
        ...
        Allure.step("Enter asset details: Name, Account, Supplier, Description, Amount", () -> {
