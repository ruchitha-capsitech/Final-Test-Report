...
public class Test11 {
    ...
    @Test(description = "Increasing quantity in credit note")
    @Epic("Sales Module")
    @Feature("credit note Creation")
    @Severity(SeverityLevel.CRITICAL)
    public void Increasingquantityincreditnote() {
        ...
        Allure.step("Credit notes clicked successfully");
        ...
        Allure.step("add Credit notes clicked successfully");
        ...
        InvoiceRefNo.click();
        Allure.step("InvoiceRefNo clicked successfully");
        WebElement invoiceNo = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//div[contains(@class, 'rs-option') and normalize-space()='INV-0046']")
        ));
        invoiceNo.click();
        Allure.step("invoiceNo clicked successfully");
        WebElement Quantity = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/form/div/div[3]/div/table/tbody/tr/td[5]/div/div/div/input")
        ));
        Quantity.click();
        Quantity.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        Quantity.sendKeys("2");
        Allure.step("quantity increased  successfully");
        ...
        Allure.step("save button clicked successfully");
            WebElement view = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath(" /html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[3]/div/div/div/div[2]/div/div/div[2]/div/div/div/div/div/div[1]/div/div/div[1]/button")));
            view.click();
...
////                "Increase qty in credit as in actual invoice",
////                "Qty should not be increased",
////                " Qty is not  increasing",
////                "",
////                "Tested",
////                ""
////        );
