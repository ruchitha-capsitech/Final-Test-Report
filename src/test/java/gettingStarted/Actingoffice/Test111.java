...
public class Test111 {
    ...
    @Test(description = "Filter Mileage Claims by status")
    @Epic("Expense Claims")
    @Feature("Mileage Claims Filtering")
    @Story("User filters Mileage Claims by Deleted, Active, Paid, and Due statuses")
    @Severity(SeverityLevel.NORMAL)
    public void MileageClaims_Filtering_Test() {
        ...
        String[] filters = {"Deleted", "Active", "Paid", "Due"};
        for (String filter : filters) {
            WebElement dropdown = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[2]/div[3]/div/div/div/div[2]/div")));
            dropdown.click();
            Allure.step("Dropdown opened for filter: " + filter);

            WebElement option = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[contains(@class,'rs-option') and normalize-space()='" + filter + "']")));
            option.click();
            Allure.step(filter + " status selected");
        }
    }
...
//            elementMileage.click();
//
//            WebElement elementFilter1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[2]/div[3]/div/div/div/div[2]/div")));
...
//
//            WebElement elementFilter2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[2]/div[3]/div/div/div/div[2]/div")));
...
//
//            WebElement elementFilter3 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[2]/div[3]/div/div/div/div[2]/div")));
...
//
//            WebElement elementFilter4 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[2]/div[3]/div/div/div/div[2]/div")));
//            elementFilter4.click();
//
//            WebElement desiredOption4 = wait.until(ExpectedConditions.elementToBeClickable(
//                    By.xpath("//div[contains(@class,'rs-option') and normalize-space()='Due']")
//            ));
//            desiredOption4.click();
//        } catch (Exception e) {
