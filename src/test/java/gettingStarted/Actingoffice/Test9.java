...
public class Test9 {
    ...
    @Test(description = "Creating Sales Invoice without values")
    @Epic("Sales Module")
    @Feature("Invoice Creation")
    @Severity(SeverityLevel.CRITICAL)
    public void CreatingSalesInvoicewithoutvalues() {
...
//            String path = "screenshots/test9.png";
