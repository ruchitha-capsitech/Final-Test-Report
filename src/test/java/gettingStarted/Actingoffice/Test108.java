...
public class Test108 {
    ...
    @Test(description = "Search Mileage Claims Test")
    @Epic("Expense Claims")
    @Feature("Mileage Claim Search")
    @Story("User searches for a specific mileage claim")
    @Severity(SeverityLevel.CRITICAL)
    public void MileageClaims_Search_Test() {
        ...
        WebElement search = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[1]/div[2]/div[1]/input")));
        search.click();
        search.sendKeys("testing");
        search.sendKeys(Keys.ENTER);
        Allure.step("Searched for mileage claims with keyword 'testing'");
    }
