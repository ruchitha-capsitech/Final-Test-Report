...
public class Test189 {
    ...
    @Test(description = "Add Fixed Asset with reference number in Assets module (Test189)")
    @Epic("Bookkeeping")
    @Feature("Assets")
    @Story("Add Fixed Asset with Reference No")
    @Severity(SeverityLevel.CRITICAL)
    public void addFixedAssetWithRefTest189() {
        ...
        Allure.step("Enter asset details", () -> {
            // Asset name
            ...
            WebElement rno = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[1]/div[2]/div/div/div/input")
            ));
            rno.click();
            rno.sendKeys(Keys.chord(Keys.CONTROL, "a"));
            rno.sendKeys("FA-0001");
