...
public class Test155 {
    ...
    @Test(description = "Filter Reimbursements by Deleted status")
    @Epic("Bookkeeping")
    @Feature("Expense Claims")
    @Story("Reimbursements Filter")
    @Severity(SeverityLevel.NORMAL)
    public void FilterReimbursementsDeleted_Test() {
        ...
        Allure.step("Opened filter dropdown");
