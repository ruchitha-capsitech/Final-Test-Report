...
public class Test60 {
    ...
    @Test(description = "Import Purchases from CSV Test")
    @Epic("Purchases")
    @Feature("Import Purchases")
    @Story("Upload CSV, map fields, validate, and save invoices")
    @Severity(SeverityLevel.CRITICAL)
    public void Purchase_Import_Test() {
        ...
        WebElement importbtn = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//*[@id=\"purchase-pivot\"]/div[2]/div/div/div/div[2]/div[1]/div[1]/div/div/div/div/div/div[2]/button/span")));
        importbtn.click();
        Allure.step("Clicked Import Purchases");
        ...
        elementupload.click();
        Allure.step("CSV file uploaded (placeholder - replace with file upload sendKeys)");
        ...
        Allure.step("Clicked Import to process file");
        ...
        elementsave.click();
        Allure.step("Invoices saved after validation");
