...
public class Test137 {
    ...
    @Test(description = "Filter Transactions by 'Manually added'")
    @Epic("Banking")
    @Feature("Transaction Filtering")
    @Story("Apply filter to show manually added transactions")
    @Severity(SeverityLevel.NORMAL)
    public void FilterManuallyAddedTransactions_Test() {
        ...
        WebElement filterButton = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[2]/div/div[4]/div/div/div[2]/div")));
        filterButton.click();
        Allure.step("Filter dropdown opened");

        WebElement manuallyAddedOption = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//div[contains(@class,'rs-option') and normalize-space()='Manually added']")));
        manuallyAddedOption.click();
        Allure.step("'Manually added' filter applied");
    }
...
//        account.click();
//
//        WebElement elementFilter = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[2]/div/div[4]/div/div/div[2]/div")));
//        elementFilter.click();
//
