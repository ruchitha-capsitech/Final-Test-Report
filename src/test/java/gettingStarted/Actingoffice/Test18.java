...
public class Test18 {
    ...
    @Test(description = "Importing sales invoice without uploading any file")
    @Epic("Sales Module")
    @Feature("Importing sales invoice without uploading any file")
    @Severity(SeverityLevel.CRITICAL)
    public void Importingsalesinvoicewithoutuploadinganyfile() {
...
//            String path = "screenshots/test18.png";
