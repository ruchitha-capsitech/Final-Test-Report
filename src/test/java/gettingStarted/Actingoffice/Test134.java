...
public class Test134 {
    ...
    @Test(description = "Open Banking History")
    @Epic("Banking")
    @Feature("Transaction History")
    @Story("Navigate to history section of account")
    @Severity(SeverityLevel.NORMAL)
    public void OpenHistory_Test() {
        ...
        WebElement history = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[1]/div[2]/button[3]")));
        history.click();
        Allure.step("History section opened");
    }
...
//        account.click();
//
//        WebElement history = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[1]/div[2]/button[3]")));
//        history.click();
//    }}