...
public class Test114 {
    ...
    @Test(description = "Import Banking Transactions via CSV")
    @Epic("Banking")
    @Feature("CSV Import")
    @Story("Upload and import transactions from a CSV file")
    ...
    public void ImportCSV_Test() {
        ...
        csv.click();
        Allure.step("CSV import option clicked");
        ...
        upload.click();
        Allure.step("Upload button clicked (CSV file to be selected)");
        ...
        importbtn.click();
        Allure.step("Import button clicked");

        WebElement next = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//*[@id=\"root\"]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[3]/button[2]")));
        next.click();
        Allure.step("next button clicked");

        WebElement back = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[3]/div/div/div[2]/div[1]/div/div/div/div/div/div/button")));
        back.click();
...
//            importbtn.click();
//
//            WebElement keepall= wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/button[2]")));
//            keepall.click();
//
//            WebElement yes= wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div/button[1]")));
//            yes.click();
//        } catch (Exception e) {
