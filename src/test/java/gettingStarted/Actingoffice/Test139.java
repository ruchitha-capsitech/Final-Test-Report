...
public class Test139 {
    ...
    @Test(description = "Generate Profit and Loss Report")
    @Epic("Reports")
    @Feature("Profit and Loss")
    @Story("Generate profit and loss report for given date range")
    @Severity(SeverityLevel.CRITICAL)
    public void ProfitAndLossReport_Test() {
        ...
        WebElement profitAndLoss = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[1]/div/div/div[1]")));
        profitAndLoss.click();
        Allure.step("Profit and Loss report selected");
...
//
//        WebElement profitandloss= wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[1]/div/div/div[1]")));
//        profitandloss.click();
//
//
...
//        elementFrom.sendKeys("08/01/2005");
//
