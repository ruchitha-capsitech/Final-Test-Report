...
public class Test113 {
    ...
    @Test(description = "Add Money In Transaction in Banking")
    @Epic("Banking")
    @Feature("Money In")
    @Story("Add a new Money In entry with date, amount and description")
    @Severity(SeverityLevel.CRITICAL)
    public void AddMoneyIn_Test() {
        ...
        WebElement add = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[2]/div/button[1]")));
        add.click();
        Allure.step("Add transaction clicked");
        ...
        Allure.step("Money In amount entered");
