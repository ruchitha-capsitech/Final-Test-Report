...
public class Test104 {
    ...
    @Test(description = "Edit Mileage Claim Test")
    @Epic("Expense Claims")
    @Feature("Mileage Claim Edit")
    @Story("User edits a mileage claim and saves the changes")
    @Severity(SeverityLevel.CRITICAL)
    public void MileageClaims_Edit_Test() {
        ...
        WebElement milageno = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[1]/div[1]/div/div[2]/div[1]/div[1]/div/div/div/input")));
        milageno.click();
        milageno.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        milageno.sendKeys("MIL-0001");
        Allure.step("Updated Mileage Number");
        ...
        save.click();
        Allure.step("Saved updated mileage claim");
    }
