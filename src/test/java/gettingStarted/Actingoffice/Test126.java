...
public class Test126 {
    ...
    @Test(description = "Create Bank Rule via Cash Coding")
    @Epic("Banking")
    @Feature("Cash Coding")
    @Story("Create new bank rule from transaction")
    @Severity(SeverityLevel.CRITICAL)
    public void CreateBankRule_Test() {
        ...
        WebElement cashcoding = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[1]/div[2]/button[2]")));
        cashcoding.click();
        Allure.step("Cash coding opened");

        WebElement dropdown = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[3]/div/div/div[3]/div[1]/div[2]/div/div[2]/div[2]/div/div/div/div[10]/div/div/div[1]/div/div/button")));
        dropdown.click();
        Allure.step("Dropdown opened for transaction");

        WebElement bankrule = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[2]/div/div/div/div/div[3]/div/div/ul/li[1]/button")));
        bankrule.click();
        Allure.step("Bank rule option selected");

        WebElement rulename = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div[1]/div[1]/div/div/div/input")));
        rulename.click();
        rulename.sendKeys("testrule12399");
        Allure.step("Entered rule name");

        WebElement applyto = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div[1]/div[2]/div/div/div/div[2]/div")));
        applyto.click();
        WebElement option = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='Money In']")));
        option.click();
        Allure.step("Applied rule to Money In transactions");
        ...
        save.click();
        Allure.step("Bank rule saved successfully");
    }
...
//        dropdown.click();
//
//        WebElement bankrule = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[3]/div/div/ul/li[1]/button")));
//        bankrule.click();
//
//        WebElement rulename = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div[1]/div[1]/div/div/div/input")));
//        rulename.click();
//        rulename.sendKeys("testrule123");
//
//        WebElement applyto = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div[1]/div[2]/div/div/div/div[2]/div")));
//        applyto.click();
//        WebElement option = wait.until(ExpectedConditions.visibilityOfElementLocated(
//                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='Money In']")
//        ));
