...
public class Test43 {
    ...
    @Test(description = "Import Purchases without uploading file Test")
    @Epic("Purchases")
    @Feature("Import Purchases")
    @Severity(SeverityLevel.NORMAL)
    public void Import_Purchases_WithoutFile_Test() {
        ...
        WebElement elementSave = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/div/div[3]/button[2]/span")));
        elementSave.click();
        Allure.step("Save button clicked without selecting a file");
...
//        WebElement elementSave = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/div/div[3]/button[2]/span")));
//        elementSave.click();
//            test.pass("Save button clicked  successfully");
//            String path = "screenshots/test43.png";
...
////                "Import purchases",
////                "",
////                "Click on import without uploading any file",
////                "System will give validation & will not import data",
////                "Select file",
////                "",
////                "Tested",
////                ""
