...
public class Test6 {
    ...
    @Test(description = "Credit note Creation when part payment recieved")
    @Epic("Sales Module")
    @Feature("Credit note Creation")
    @Severity(SeverityLevel.CRITICAL)
    public void CreditnoteCreationwhenpartpaymentrecieved() {
        ...
        invoiceNo.click();
        Allure.step(" invoice number selected");
        WebElement saveBtn = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//button[.//span[text()='Save']]")
        ));
        saveBtn.click();
        Allure.step(" save clicked");
...
//            String path1 = "screenshots/test6.png";
...
////                "Input/Sales",
////                "Create Credit note",
////                "Sales invoice created and part payment received from customer",
...
////                "Credit note created and related sales invoice due amount reduced by credit note amount. Also General ledger of Sales, VAT and Customer updated. Also General ledger of Sales, VAT and Customer updated.",
////                "Amount got updated ,and refund amount is updated to the part payment recieved from customer",
////                "",
////                "Tested",
////                ""
////        );
