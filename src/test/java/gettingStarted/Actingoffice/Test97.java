...
public class Test97 {
    ...
    @Test(description = "Mileage Claim - Save without selecting user")
    @Epic("Expense Claims")
    @Feature("Mileage Claims")
    @Story("User tries to save mileage claim without selecting user")
    @Severity(SeverityLevel.CRITICAL)
    public void ExpenseClaims_MileageClaimWithoutUser_Test() {
        ...
        save.click();
        Allure.step("Clicked Save button without selecting user");
...
//                "Create mileage",
//                "",
//                "Click on “Add Mileage” and then click on “Save” without selecting a user.",
//                "You cannot save without selecting a user; a validation message for the mandatory field will appear.",
//                "verified in uat",
//                "",
//                "Tested",
//                ""
