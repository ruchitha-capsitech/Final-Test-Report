...
public class Test96 {
    ...
    @Test(description = "Create Mileage Claim Test")
    @Epic("Expense Claims")
    @Feature("Mileage Claims")
    @Story("User creates a mileage claim and validates it is saved correctly")
    @Severity(SeverityLevel.CRITICAL)
    public void ExpenseClaims_MileageClaimCreation_Test() {
...
//                "Create mileage",
//                "",
//                "1. Click on add mileage button.\n" +
//                        "2. Select the date, choose the vehicle type, and enter the remark.\n" +
//                        "3. Select the engine type, enter the description, fill in the mileage (in miles), enter the number of co-passengers, tick the checkbox for ‘Reclaim VAT on mileage’, and after entering all the details correctly, click on the Save button.",
//                "The mileage claim you added has been saved correctly, and the details have been properly recorded in the reports, including the Profit and Loss Account, General Ledger, and Trial Balance.",
//                "verified in uat",
//                "",
//                "Tested",
//                ""
