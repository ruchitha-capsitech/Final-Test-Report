...
public class Test120 {
    ...
    @Test(description = "Exclude a banking transaction")
    @Epic("Banking")
    @Feature("Transactions")
    @Story("Exclude transaction from account")
    @Severity(SeverityLevel.NORMAL)
    public void ExcludeTransaction_Test() {
        ...
        WebElement exclude = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[3]/div[2]/div/div/div/div/div[2]/div[2]/div[1]/div/div/div[10]/div/div/div/div/button")));
        exclude.click();
        Allure.step("Exclude button clicked for transaction");
        ...
        yes.click();
        Allure.step("Confirmed exclude action");
    }
...
//        account.click();
//
//        WebElement exclude = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[3]/div[2]/div/div/div/div/div[2]/div[2]/div/div/div/div[10]/div/div/div[2]/div/button")));
//        exclude.click();
//
