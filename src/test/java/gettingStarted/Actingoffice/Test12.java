...
public class Test12 {
    ...
    @Test(description = "Increasing discount in credit note")
    @Epic("Sales Module")
    @Feature("credit note Creation")
    @Severity(SeverityLevel.CRITICAL)
    public void Increasingdiscountincreditnote() {
        ...
        WebElement invoiceNo = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//div[contains(@class, 'rs-option') and normalize-space()='INV-0006']")
        ));
        invoiceNo.click();
        Allure.step("invoiceNo selected  successfully");
        WebElement Discount = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/form/div/div[2]/div[2]/div/div[2]/div/div/input")
        ));
        Discount.click();
        Discount.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        Discount.sendKeys("10");
        Allure.step("Discount increased  successfully");
            WebElement saveBtn = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/form/div/div[3]/div/div[4]/div[2]/div[2]/div[3]/button[2]")
            ));
        saveBtn.click();
        saveBtn.click();
        ...
        Allure.step("save button clicked successfully");
            ...
            WebElement accountDropdown = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[2]/table/tbody/tr/td[2]/div/div/div/div[2]/div")
            ));
...
//            String path = "screenshots/test12.png";
...
////                "Create credit note against an invoice in which discount was given. Increase discount as in invoice",
////                "Discount should not be increased",
////                " Discount is not  increasing",
////                "",
////                "Tested",
////                ""
////        );
