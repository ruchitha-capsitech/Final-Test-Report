...
public class Test129 {
    ...
    @Test(description = "Select account head for a transaction")
    @Epic("Banking")
    @Feature("Transactions")
    @Story("Select specific account head for a transaction")
    @Issue("the vat field is getting displayed ")
    @Severity(SeverityLevel.CRITICAL)
    public void SelectAccountHead_Test() {

        driver.navigate().to("https://accountsdev.actingoffice.com/login?returnUrl=%2Foauth%2Fauthorize%2Fcallback%3Fclient_id%3Dweb%26redirect_uri%3Dhttps%253A%252F%252Fappdev.actingoffice.com%252Foidc-callback");
