...
public class Test77 {
    ...
    @Test(description = "Reverse a journal entry")
    @Epic("Journals")
    @Feature("Reverse Journal")
    @Story("Reverse an existing journal entry and create a new reverse entry")
    @Severity(SeverityLevel.CRITICAL)
    public void Journal_Reverse_Test() {
        ...
        save.click();
        Allure.step("Clicked Save button to create reverse journal entry");
    }
...
//                "Reverse journal",
//                "",
//                "Click the 'Reverse Journal' button to reverse the entry.",
//                "A new journal entry will be generated with the reverse effect.",
//                "verified",
//                "",
//                "Tested",
//                ""
