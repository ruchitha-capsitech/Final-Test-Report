...
public class Test164 {
    ...
    @Test(description = "Download a Refund (Second Option)")
    @Epic("Bookkeeping")
    @Feature("Expense Claims")
    @Story("Refunds Download Option 2")
    @Severity(SeverityLevel.CRITICAL)
    public void downloadRefundOption2Test() {
        // Login
        ...
        // Open dropdown → click second download option
        WebElement dropdown = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div[2]/div/div/div[2]/div/div/div/div/div/div/div/div/div[7]/div/div[2]/div/button")));
        dropdown.click();
        Allure.step("Clicked refund action dropdown");
        ...
        downloadBtn.click();
        Allure.step("Clicked Download button (second option)");
    }
...
//        elementRefund.click();
//
//        WebElement dropdown = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div[2]/div/div/div[2]/div/div/div/div/div/div/div/div/div[7]/div/div[2]/div/button")));
//        dropdown.click();
//
//        WebElement download = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[3]/div/div/ul/li[2]/button")));
//        download.click();
//
//
//    }}
