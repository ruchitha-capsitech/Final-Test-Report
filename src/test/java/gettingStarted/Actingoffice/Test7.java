...
public class Test7 {
    ...
    @Test(description = "Estimates Creation")
    @Epic("Sales Module")
    ...
    public void CreateEstimates() {
        ...
        Allure.step("entered email address");
        ...
        Allure.step("estimates button clicked  successfully");
        WebElement addEstimate = wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("Estimate")));
        addEstimate.click();
        Allure.step("add estimates button clicked  successfully");
