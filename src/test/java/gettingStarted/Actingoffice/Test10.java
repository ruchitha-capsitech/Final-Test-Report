...
public class Test10 {
    ...
    @Test(description = "Create sales invoice for service without account head")
    @Epic("Sales Module")
    @Feature("Invoice Creation")
    @Severity(SeverityLevel.CRITICAL)
    public void CreatingSalesInvoicewithoutaccounthead() {
        ...
        WebElement elementService = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div/div[3]/div[2]/form/div/div[2]/div[1]/button/span")));
        elementService.click();
        Allure.step("service button clicked successfully");
...
//            String path = "screenshots/test10.png";
...
////                "Account head is empty",
////                "Click on save without selecting account head related to service",
////                "It should give validation & should not be saved",
////                " It is giving validation & not saving",
////                "",
////                "Tested",
////                ""
////        );
