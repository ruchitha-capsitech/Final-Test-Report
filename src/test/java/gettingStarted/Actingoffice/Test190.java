...
public class Test190 {
    ...
    @Test(description = "Add Fixed Asset with Purchase Date in Assets module (Test190)")
    @Epic("Bookkeeping")
    @Feature("Assets")
    @Story("Add Fixed Asset with Purchase Date")
    @Severity(SeverityLevel.CRITICAL)
    public void addFixedAssetWithPurchaseDate() {
        ...
        Allure.step("Enter asset details including Purchase Date", () -> {
            ...
            WebElement pdate = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[1]/div[3]/div/div/div/div/div/input")));
            pdate.click();
            pdate.sendKeys(Keys.chord(Keys.CONTROL, "a"));
            pdate.sendKeys(Keys.DELETE);

            WebElement accountDropdown = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[2]/div[1]/div/div/div/div[1]/div[2]/input")));
            accountDropdown.click();
            WebElement desiredOption = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[contains(@class,'rs-option') and normalize-space()='Goodwill - Additions cost - 101/2']")));
            desiredOption.click();

            WebElement supplier = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[3]/div[2]/div/div/div/div[1]/div[2]/input")));
            supplier.click();
            WebElement desiredOption1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[contains(@class,'rs-option') and normalize-space()='GG Aegon Limited (Mark Wood)']")));
            ...
            WebElement amountInput = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[2]/div[2]/div/div/div/input")));
            amountInput.sendKeys(Keys.chord(Keys.CONTROL, "a"));
            amountInput.sendKeys("£600.00");

            WebElement rate = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[10]/div[1]/div[3]/div[1]/div/div/input")));
        ...
        Allure.step("Update Purchase Date and Save again", () -> {
            WebElement pdate1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[1]/div[3]/div/div/div/div/div/input")));
            pdate1.click();
            pdate1.clear();
            pdate1.sendKeys("abcd");
...
//        assetname.sendKeys("test");
//
//        WebElement pdate = wait.until(ExpectedConditions.elementToBeClickable(
//                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[1]/div[3]/div/div/div/div/div/input")
//        ));
//        pdate.click();
//        pdate.clear();
//
//        WebElement accountDropdown = wait.until(ExpectedConditions.elementToBeClickable(
//                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[2]/div[1]/div/div/div/div[1]/div[2]/input")
//        ));
//        accountDropdown.click();
//        WebElement desiredOption = wait.until(ExpectedConditions.elementToBeClickable(
//                By.xpath("//div[contains(@class,'rs-option') and normalize-space()='Goodwill - Additions cost - 101/2']")
//        ));
//        desiredOption.click();
//
...
//        save.click();
//
//        WebElement pdate1 = wait.until(ExpectedConditions.elementToBeClickable(
//                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[1]/div[3]/div/div/div/div/div/input")
//        ));
//        pdate1.click();
//        pdate1.clear();
//        pdate1.sendKeys("test");
//
//        WebElement save1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[3]/div[2]/div[2]/button[2]")));
//        save1.click();
//    }}