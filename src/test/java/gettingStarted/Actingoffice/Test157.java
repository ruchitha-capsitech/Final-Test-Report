...
public class Test157 {
    ...
    @Test(description = "Add Refund in Expense Claims")
    @Epic("Bookkeeping")
    @Feature("Expense Claims")
    @Story("Refunds")
    @Severity(SeverityLevel.CRITICAL)
    public void AddRefund_Test() {
        ...
        WebElement addRefund = wait.until(ExpectedConditions.elementToBeClickable(By.name("Refund")));
        addRefund.click();
        Allure.step("Add Refund button clicked");
        ...
        user.click();
        Allure.step("Refund user 'Testuser' selected");
        ...
        note.click();
        note.sendKeys("test");
        Allure.step("Note entered as 'test'");
