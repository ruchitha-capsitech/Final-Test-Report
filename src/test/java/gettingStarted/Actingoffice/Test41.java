...
public class Test41 {
    ...
    @Test(description = "Create Purchase Invoice with Empty Mandatory Fields Test")
    @Epic("Purchases")
    @Feature("Purchase Invoice")
    @Severity(SeverityLevel.CRITICAL)
    public void Create_Purchase_Invoice_EmptyFields_Test() {
        ...
        saveButton.click();
        Allure.step("Save button clicked without entering any details");

        // Business expectation
        Allure.step("❌ Mandatory fields highlighted in red boxes as expected");
    }
...
//            String path = "screenshots/test41.png";
...
////                "All mandatory details should be empty",
////                "Directly click on save without input any details",
////                "All mandatory fields should appear in red box",
////                "verified",
////                "",
////                "Tested",
////                ""
