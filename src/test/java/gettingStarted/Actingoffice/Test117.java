...
public class Test117 {
    ...
    @Test(description = "Match banking transaction with purchase invoice")
    @Epic("Banking")
    @Feature("Transactions")
    @Story("Match transaction with supplier purchase invoice")
    @Severity(SeverityLevel.CRITICAL)
    public void MatchTransactionWithInvoice_Test() {
        ...
        findmatch.click();
        Allure.step("Find match clicked");
        ...
        Allure.step("Contact field clicked");

//        WebElement option = wait.until(ExpectedConditions.visibilityOfElementLocated(
//                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='A LIMITED(Supplier)']")));
//        option.click();
        ...
        invoices.click();
        Allure.step("Invoice field clicked");

        WebElement option1 = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='PUR-0036 | Purchase Invoice | 05/09/2025 | £600.00']")));
        option1.click();
        Allure.step("Invoice selected");

        WebElement banktrasfer = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[3]/div[2]/div/div/div/div/div[2]/div[2]/div[2]/div/div/div[3]/div/div/table/tbody/tr[5]/td[3]/div/div/div/div/div[2]/div")));
        banktrasfer.click();
        Allure.step("Bank Charges clicked");

        WebElement BankCharges = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='Bank Charges']")));
        BankCharges.click();
        Allure.step("Bank Charges selected");
        ...
        match.click();
        Allure.step("Transaction matched with invoice");
    }
...
//        contact.click();
//        WebElement option = wait.until(ExpectedConditions.visibilityOfElementLocated(
//                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='GG Aegon Limited (Mark Wood) (Supplier)']")
//        ));
//        option.click();
//
...
//        invoices.click();
//        WebElement option1 = wait.until(ExpectedConditions.visibilityOfElementLocated(
//                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='10023 | Purchase Invoice | 01/02/2024 | £216.00']")
//        ));
//        option1.click();
//
