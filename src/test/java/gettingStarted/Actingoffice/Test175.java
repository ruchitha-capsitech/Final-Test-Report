...
public class Test175 {
    ...
    @Test(description = "Edit user's date of birth Test 175")
    @Epic("Bookkeeping")
    @Feature("Users")
    @Story("Edit User DOB")
    @Severity(SeverityLevel.CRITICAL)
    public void editUserDOBTest175() {
        ...
        Allure.step("Update Date of Birth field", () -> {
            ...
            dob.click();
            dob.sendKeys(Keys.chord(Keys.CONTROL, "a"));// click preserved
