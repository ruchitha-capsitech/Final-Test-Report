...
public class Test166 {
    ...
    public void addUserTest() {
        ...
        WebElement titleDropdown = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/div/form/div/div/div[1]/div[2]/div/div/div[2]/div/div/input")));
        titleDropdown.click();

        WebElement titleOption = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='Mrs']")));
        titleOption.click();
        Allure.step("Selected title: Mrs");
        ...
        Allure.step("Entered first name: testing-user1");
        ...
        Allure.step("Entered phone number: 12345678901");
        ...
        Allure.step("Entered date of birth: 04/08/2002");
