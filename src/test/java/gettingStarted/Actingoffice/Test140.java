...
public class Test140 {
    ...
    @Test(description = "Generate Balance Sheet Report")
    @Epic("Reports")
    @Feature("Balance Sheet")
    @Story("Generate balance sheet report for a given date")
    @Issue("Only one date can be selected,to view the balance sheet of that day.")
    @Severity(SeverityLevel.CRITICAL)
    public void BalanceSheetReport_Test() {
        ...
        WebElement reportsBtn = wait.until(ExpectedConditions.elementToBeClickable(By.id("reports")));
        reportsBtn.click();
        Allure.step("Reports section opened");

        WebElement balanceSheet = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[1]/div/div/div[2]")));
        balanceSheet.click();
        Allure.step("Balance Sheet report selected");

        WebElement date = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[1]/div[1]/div[2]/div[1]/div/div/div/div/input")));
        date.click();
        date.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        date.sendKeys("25/08/2025");
        Allure.step("Report date entered: 25/08/2025");
        ...
        refresh.click();
        Allure.step("Balance Sheet refreshed");
    }
...
//
//        WebElement balancesheet= wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[1]/div/div/div[2]")));
//        balancesheet.click();
//
//
//        WebElement date = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[1]/div[1]/div[2]/div[1]/div/div/div/div/input")));
//        date.click();
//        date.sendKeys(Keys.chord(Keys.CONTROL, "a"));
//        date.sendKeys("25/08/2025");
//
