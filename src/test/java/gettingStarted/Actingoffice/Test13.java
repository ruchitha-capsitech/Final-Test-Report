...
public class Test13 {
    ...
    @Test(description = "Increasing price in credit note")
    @Epic("Sales Module")
    @Feature("credit note Creation")
    @Severity(SeverityLevel.CRITICAL)
    public void Increasingpriceincreditnote() {
        ...
        WebElement invoiceNo = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//div[contains(@class, 'rs-option') and normalize-space()='INV-0005']")
        ));
        invoiceNo.click();
        Allure.step("invoiceNo selected  successfully");
        WebElement price = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/form/div/div[3]/div/table/tbody/tr/td[6]/div/div/div/input")
        ));
        price.click();
        price.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        price.sendKeys("15000");
        Allure.step("price entered  successfully");
        ...
        Allure.step("Save button clicked  successfully");
            WebElement accountDropdown = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[2]/table/tbody/tr/td[2]/div/div/div/div[1]/div[2]/input")
            ));
...
//            String path = "screenshots/test13.png";
...
////                "Increase price of any item with its actual price in invoice",
