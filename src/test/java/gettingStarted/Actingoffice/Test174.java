...
public class Test174 {
    ...
    @Test(description = "Edit user's phone number Test 174")
    @Epic("Bookkeeping")
    @Feature("Users")
    @Story("Edit User Phone Number")
    @Severity(SeverityLevel.CRITICAL)
    public void editUserPhoneNumberTest174() {
        ...
        Allure.step("Update Phone Number field", () -> {
