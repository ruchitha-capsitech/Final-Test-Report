...
public class Test147 {
    ...
    @Test(description = "Create Reimbursement with User under Expense Claims")
    @Epic("Bookkeeping")
    @Feature("Expense Claims")
    @Story("Reimbursement Creation with User")
    @Severity(SeverityLevel.CRITICAL)
    public void ReimbursementWithUser_Test() {
        ...
        Allure.step("Entered reimbursement amount: £600.00");
        ...
        WebElement rno = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div/div[3]/form/div/div[1]/div[1]/div[1]/div[2]/div/div/div/input")));
        rno.click();
        rno.clear();
        Allure.step("Reference number cleared");
