...
public class Test125 {
    ...
    @Test(description = "Edit settings date in Company settings")
    @Epic("Settings")
    @Feature("Company")
    @Story("Edit and save date field in settings")
    @Severity(SeverityLevel.NORMAL)
    public void EditCompanySettingsDate_Test() {
        ...
        Allure.step("Settings section opened");
        ...
        WebElement date = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div[2]/div/div/div/div/div/div[3]/div/form/div[3]/div[3]/div/div/div/div/div/div/input")));
        date.click();
        date.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        date.sendKeys("08/09/2025");
        Allure.step("Date updated ");

        WebElement save = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div[2]/div/div/div/div/div/div[3]/div/form/div[3]/div[9]/div[2]/div/button[2]")));
        save.click();

        WebElement save1 = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div[2]/div/div/div/div/div/div[3]/div/form/div[3]/div[9]/div[2]/div/button[2]")));
        save1.click();
        Allure.step("Settings saved");
    }
...
//       edit.click();
//
//        WebElement date = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div[2]/div/div/div/div/div/div[3]/div/form/div[3]/div[3]/div/div/div/div/div/div/input")));
//        date.click();
//        date.sendKeys(Keys.chord(Keys.CONTROL, "a"));
//        date.sendKeys("26/08/2025");
//
//        WebElement save = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div[2]/div/div/div/div/div/div[2]/div/form/div[3]/div[9]/div[2]/div/button[2]")));
//        save.click();
//
//    }}