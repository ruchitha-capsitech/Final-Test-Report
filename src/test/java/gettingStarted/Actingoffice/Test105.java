...
public class Test105 {
    ...
    @Test(description = "Add attachment to Mileage Claim Test")
    @Epic("Expense Claims")
    @Feature("Mileage Claim Attachments")
    @Story("User adds attachments to a mileage claim and saves it")
    @Issue("Both the files attached are being displayed,the first one is not getting removed")
    @Severity(SeverityLevel.CRITICAL)
    public void MileageClaims_Attachment_Test() {
        ...
        WebElement edit = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[2]/div/div/div[2]/div/div/div/div/div/div/div/div/div[8]/div/div[2]/div/button")));
        edit.click();
        Allure.step("Clicked Edit on existing mileage claim");

        // Click to add attachments
        WebElement attachment = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[1]/div[1]/div/div[2]/div[2]/div/div/button")));
        attachment.click();
        Allure.step("Clicked Add Attachment button");

        // Click again for second attachment if needed
        WebElement attachment1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[1]/div[1]/div/div[2]/div[2]/div/div/button")));
        attachment1.click();
        Allure.step("Clicked Add Attachment button again");
        ...
        save.click();
        Allure.step("Saved mileage claim with attachments");

        WebElement mileageDashboard = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[2]/div/div/div[2]/div/div/div/div/div/div/div/div/div[1]/button")));
        mileageDashboard.click();
        Allure.step("Navigated back to mileage claims dashboard");
    }
...
//            save.click();
//
//            WebElement milege = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[2]/div/div/div[2]/div/div/div/div/div/div/div/div/div[1]/button")));
//            milege.click();
//        } catch (Exception e) {
