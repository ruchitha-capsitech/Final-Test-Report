...
public class Test100 {
    ...
    @Test(description = "Mileage Claim - Remarks is mandatory")
    @Epic("Expense Claims")
    @Feature("Mileage Claims")
    @Story("User tries to save mileage claim without entering remarks")
    @Severity(SeverityLevel.CRITICAL)
    public void ExpenseClaims_RemarksMandatory_Test() {
        ...
        Allure.step("Skipped entering remarks (mandatory field)");
        ...
        save.click();
        Allure.step("Clicked Save button - validation should prevent saving without remarks");
    }
