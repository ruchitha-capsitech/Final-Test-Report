...
public class Test80 {
    ...
    @Test(description = "Filter journals by date range")
    @Epic("Journals")
    @Feature("Date Range Filter")
    @Story("Apply a custom date range to filter journal entries")
    @Severity(SeverityLevel.NORMAL)
    public void Journal_DateRange_Test() {
        ...
        WebElement elementFrom = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div/div[3]/div[1]/div[2]/div[2]/div/div/div/div/input")));
        elementFrom.click();
        elementFrom.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        elementFrom.sendKeys("01/02/2025");
        Allure.step("Entered 'From' date");

        WebElement elementTo = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div/div[3]/div[1]/div[2]/div[3]/div/div/div/div/input")));
        elementTo.click();
        elementTo.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        elementTo.sendKeys("28/10/2025");
        Allure.step("Entered 'To' date");
        ...
        refresh.click();
        Allure.step("Clicked Refresh to apply date range");
    }
