...
public class Test194 {
    ...
    @Test(description = "Add Fixed Asset with VAT, Account, Supplier, Description, Amount, and Rate (Test194)")
    @Epic("Bookkeeping")
    @Feature("Assets")
    @Story("Add Fixed Asset with VAT and full details")
    @Severity(SeverityLevel.CRITICAL)
    public void addFixedAssetWithVAT() {
        ...
        Allure.step("Enter asset details: Name, VAT, Account, Supplier, Description, Amount, Rate", () -> {
