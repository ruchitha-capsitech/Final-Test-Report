...
public class Test172 {
    ...
    @Test(description = "Edit an existing User Test 172")
    @Epic("Bookkeeping")
    @Feature("Users")
    @Story("Edit User")
    @Severity(SeverityLevel.CRITICAL)
    public void editUserTest172() {
        ...
        Allure.step("Select Title", () -> {
            ...
            WebElement fname = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='Mr']")));
...
//                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='Mr']")
//        ));
//        fname.click();
//
