...
public class Test192 {
    ...
    @Test(description = "Add Fixed Asset without Purchase Date and with Account selection (Test192)")
    @Epic("Bookkeeping")
    @Feature("Assets")
    @Story("Add Fixed Asset with Account selection")
    @Severity(SeverityLevel.CRITICAL)
    public void addFixedAssetWithAccount() {
