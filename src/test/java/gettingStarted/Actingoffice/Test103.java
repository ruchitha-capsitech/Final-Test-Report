...
public class Test103 {
    ...
    @Test(description = "Mileage Claim - Create with description field")
    @Epic("Expense Claims")
    @Feature("Mileage Claims")
    @Story("User creates mileage claim with remarks, engine type, and description")
    @Severity(SeverityLevel.CRITICAL)
    public void ExpenseClaims_CreateMileageWithDescription_Test() {
        ...
        Allure.step("Re-entered password using common method");
        ...
        Allure.step("Entered remarks: testing");
        ...
        Allure.step("Entered description: testing description");
        ...
        save.click();
        Allure.step("Clicked Save button to create mileage claim");
    }
