...
public class Test160 {
    ...
    @Test(description = "Filter Refunds by date range and refresh results")
    @Epic("Bookkeeping")
    @Feature("Expense Claims")
    @Story("Refunds Date Filter")
    @Severity(SeverityLevel.CRITICAL)
    public void RefundsDateFilter_Test() {
        ...
        expenseClaims.click();
        Allure.step("Expense claims section opened");

        WebElement refundTab = wait.until(ExpectedConditions.elementToBeClickable(By.name("Refunds")));
        refundTab.click();
        Allure.step("Refunds tab opened");

        // First date range: 2025
        WebElement fromDate = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div[1]/div[2]/div[2]/div/div/div/div/input")));
        fromDate.click();
        fromDate.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        fromDate.sendKeys("02/02/2025");

        WebElement toDate = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div[1]/div[2]/div[3]/div/div/div/div/input")));
        toDate.click();
        toDate.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        toDate.sendKeys("29/10/2025");

        WebElement refreshBtn = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div[1]/div[2]/button")));
        refreshBtn.click();
        Allure.step("Date filter applied: 02/02/2025 - 29/10/2025");

        // Second date range: 2000–2001
        WebElement fromDate2 = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div[1]/div[2]/div[2]/div/div/div/div/input")));
        fromDate2.click();
        fromDate2.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        fromDate2.sendKeys("01/02/2000");

        WebElement toDate2 = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div[1]/div[2]/div[3]/div/div/div/div/input")));
        toDate2.click();
        toDate2.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        toDate2.sendKeys("28/10/2001");

        WebElement refreshBtn2 = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div[1]/div[2]/button")));
        refreshBtn2.click();
        Allure.step("Date filter applied: 01/02/2000 - 28/10/2001");
    }
...
//        elementRefund.click();
//
//        WebElement elementFrom = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div[1]/div[2]/div[2]/div/div/div/div/input")));
//        elementFrom.click();
//        elementFrom.sendKeys(Keys.chord(Keys.CONTROL, "a"));
//        elementFrom.sendKeys("02/02/2025");
//
//        WebElement elementTo = wait.until(ExpectedConditions.elementToBeClickable( By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div[1]/div[2]/div[3]/div/div/div/div/input")));
//        elementTo.click();
//        elementTo.sendKeys(Keys.chord(Keys.CONTROL, "a"));
//        elementTo.sendKeys("29/10/2025");
//
...
//        refresh.click();
//
//        WebElement elementFrom1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div[1]/div[2]/div[2]/div/div/div/div/input")));
//        elementFrom1.click();
//        elementFrom1.sendKeys(Keys.chord(Keys.CONTROL, "a"));
//        elementFrom1.sendKeys("01/02/2000");
//
//        WebElement elementTo1 = wait.until(ExpectedConditions.elementToBeClickable( By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div[1]/div[2]/div[3]/div/div/div/div/input")));
//        elementTo1.click();
//        elementTo1.sendKeys(Keys.chord(Keys.CONTROL, "a"));
//        elementTo1.sendKeys("28/10/2001");
//
