...
public class Test83 {
    ...
    @Test(description = "Import banking transactions")
    @Epic("Banking")
    @Feature("Import CSV")
    @Story("Upload CSV with transactions dated before bookkeeping start date")
    @Severity(SeverityLevel.CRITICAL)
    public void Banking_ImportTransactions_Test() {
        ...
        account.click();
        Allure.step("Bank account selected");

        WebElement csv = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/ul[1]/li[2]/button")));
        csv.click();
        Allure.step("Clicked 'CSV' import");

        WebElement upload = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/div/div[1]/div[3]/i")));
        upload.click();
        Allure.step("Upload CSV file");

        WebElement importBtn = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/div/div[1]/div[4]/div/button")));
        importBtn.click();
        Allure.step("Clicked 'Import' button");
        ...
        next.click();
        Allure.step("Clicked 'Next' button");

        WebElement ignore = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[3]/div/div[2]/div/button[2]")));
        ignore.click();
        Allure.step("Clicked 'Ignore' warning for pre-start date transactions");
...
//            account.click();
//
//            WebElement csv = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/ul[1]/li[2]/button")));
//            csv.click();
//
//            WebElement upload = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/div/div[1]/div[3]/i")));
//            upload.click();
//
//            WebElement importbtn = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/div/div[1]/div[4]/div/button")));
//            importbtn.click();
//
//            WebElement next = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[3]/button[2]")));
//            next.click();
//
//            WebElement ignore = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[3]/div/div[2]/div/button[2]")));
//            ignore.click();
//        } catch (Exception e) {
...
//                "Import transactions",
//                "",
//                "Click 'Import' and upload a CSV file containing transactions dated before the bookkeeping start date.",
//                "The system will display a warning message and prevent the data from being imported.",
//                "verified",
//                "",
//                "Tested",
//                ""
