...
public class Test159 {
    ...
    @Test(description = "Search for Refund record in Expense Claims")
    @Epic("Bookkeeping")
    @Feature("Expense Claims")
    @Story("Refunds Search")
    @Severity(SeverityLevel.CRITICAL)
    public void SearchRefund_Test() {
        ...
        Allure.step("Refund search performed for 'testuser'");
    }
