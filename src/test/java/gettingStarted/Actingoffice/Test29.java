...
public class Test29 {
    ...
    @Test(description = "Setting the payment term from the settings")
    @Epic("Sales Module")
    @Feature("Setting the payment term")
    @Severity(SeverityLevel.CRITICAL)
    @Issue("The payment terms set in the settings do not appear on the invoice screen and are not visible on the downloaded PDF.")
    public void Setting_the_payment_term_from_the_settings() {
        ...
        Allure.step("Download button clicked  successfully");
