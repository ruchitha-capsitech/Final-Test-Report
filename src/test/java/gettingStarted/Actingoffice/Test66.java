...
public class Test66 {
    ...
    @Test(description = "Create and edit supplier in Purchases module")
    @Epic("Purchases")
    @Feature("Supplier")
    @Story("Add and edit supplier details")
    @Severity(SeverityLevel.CRITICAL)
    public void Purchase_CreateAndEditSupplier_Test() {
        ...
        Allure.step("Edit supplier clicked");

        WebElement Name1 = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/div/form/form/div/div[1]/div[1]/div/div[1]/div/div[1]/div/div[1]/div/div/input")));
        Name1.click();
        Name1.clear();
        Name1.sendKeys("A LIMITED123");
        Allure.step("Updated supplier name to 'A LIMITED1'");

        WebElement saveButton1 = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//button[.//span[text()='Save']]")));
        saveButton1.click();
        Allure.step("Edited supplier saved");
    }
