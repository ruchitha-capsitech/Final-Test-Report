...
public class Test44 {
    ...
    @Test(description = "Import Purchases with unmapped column Test")
    @Epic("Purchases")
    @Feature("Import Purchases")
    @Severity(SeverityLevel.CRITICAL)
    public void Import_Purchases_UnmappedColumn_Test() {
...
//        elementImportFile.click();
//            test.pass("Import File button clicked  successfully");
//        By save = By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[3]/button[2]");
//        WebElement elementSave = wait.until(ExpectedConditions.elementToBeClickable(save));
//        elementSave.click();
//            test.pass("Save button clicked  successfully");
//            String path = "screenshots/test44.png";
