...
public class Test112 {
    ...
    @Test(description = "Create Reimbursement")
    @Epic("Expense Claims")
    @Feature("Reimbursements")
    @Story("Add a new Reimbursement for a user with amount and account selection")
    @Severity(SeverityLevel.CRITICAL)
    public void CreateReimbursement_Test() {
        ...
        WebElement elementCompany = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[3]/div/div/div[2]/div/div/div/div/div[1]/div[2]/div/div/div[3]/div/a")));
        ...
        Allure.step("Reimbursements page opened");
        ...
        WebElement user = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='Aa Scruz']")));
        user.click();
        ...
        amountInput.sendKeys("£6000.00");
        Allure.step("Amount entered");
        WebElement accountDropdown = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div/div[3]/form/div/div[1]/div[1]/div[3]/div[1]/div/div/div/div[2]/div")
            ));
        ...
        WebElement saveButton = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div/div[3]/form/div/div[2]/div[2]/div[2]/div[3]/button[2]")));
        saveButton.click();
