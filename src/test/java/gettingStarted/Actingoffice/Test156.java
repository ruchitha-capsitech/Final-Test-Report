...
public class Test156 {
    ...
    @Test(description = "Refresh reimbursements in Expense Claims")
    @Epic("Bookkeeping")
    @Feature("Expense Claims")
    @Story("Reimbursements Refresh")
    @Severity(SeverityLevel.MINOR)
    public void RefreshReimbursements_Test() {
        ...
        refreshBtn.click();
        Allure.step("Reimbursements refreshed");
    }
