...
public class Test202 {
    ...
    @Test(description = "Change General Ledger report settings (Test202)")
    @Epic("Bookkeeping")
    @Feature("Reports")
    @Story("Change report settings and save")
    @Severity(SeverityLevel.NORMAL)
    public void changeGeneralLedgerSettings() {
        ...
        Allure.step("Click cog icon (settings)", () -> {
            WebElement cogIcon = wait.until(ExpectedConditions.presenceOfElementLocated(
                    By.cssSelector("i[data-icon-name='Cog']")));
            cogIcon.click();
        });

        Allure.step("Click Decimals option", () -> {
            WebElement decimals = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/div/div[1]/label/div")));
            decimals.click();
        });

        Allure.step("Click Save button", () -> {
            WebElement save = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/div/div[7]/div/button[2]")));
            save.click();
        });
    }
...
//
//
//        WebElement cogIcon = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("i[data-icon-name='Cog']")));
//        cogIcon.click();
//
//
//
//        WebElement decimals = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/div/div[1]/label/div")));
//        decimals.click();
//
//        WebElement save = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/div/div[7]/div/button[2]")));
//        save.click();
//    }}