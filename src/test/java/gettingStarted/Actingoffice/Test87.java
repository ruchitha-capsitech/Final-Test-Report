...
public class Test87 {
    ...
    @Test(description = "Expense should not save without amount")
    @Epic("Expense Claims")
    @Feature("Expense Creation Validation")
    @Story("User tries to save expense without amount")
    @Severity(SeverityLevel.CRITICAL)
    public void ExpenseClaims_Validation_Test() {
        ...
        remarks.click();
        remarks.sendKeys("Validation test - missing amount");
        ...
        description.click();
        description.sendKeys("Validation test description");
