...
public class Test85 {
    ...
    @Test(description = "Explain banking transactions")
    @Epic("Banking")
    @Feature("Explain Transactions")
    @Story("Explain one or multiple transactions with/without bank rules")
    @Severity(SeverityLevel.CRITICAL)
    public void Banking_ExplainTransactions_Test() {
        ...
        WebElement explain = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[3]/div[2]/div/div/div/div/div[2]/div[2]/div[2]/div/div/div[1]/button[1]")));
        explain.click();
        Allure.step("Clicked 'Explain' action");
        ...
        explainBtn.click();
        Allure.step("Transaction explained, journal created");
    }
...
//            transaction.click();
//
//            WebElement explain = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[3]/div[2]/div/div/div/div/div[2]/div[2]/div[2]/div/div/div[1]/button[1]")));
//            explain.click();
//
...
//                "",
//                "Click on any transaction. If a bank rule applies, the account head will be auto-selected; otherwise, select it manually. Then click 'Explain'. You can explain a single transaction or multiple transactions with the same account head.",
//                "Once transactions are explained, they will move to the 'Explained' tab. A journal will be created for each explained transaction and reflected in the corresponding ledgers.",
//                "verified",
//                "",
//                "Tested",
//                ""
