...
public class Test39 {
    ...
    @Test(description = "Help Section Redirection Test")
    @Epic("Help Section")
    @Feature("Help Navigation")
    @Severity(SeverityLevel.MINOR)
    public void Help_Section_Test() {
        ...
        WebElement elementHelp = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div[2]/a")));
        elementHelp.click();
        Allure.step("Help button clicked successfully");

        // Business expectation
        Allure.step("✅ System redirected to respective Help section");
    }
