...
public class Test143 {
    ...
    @Test(description = "Verifying delete option")
    @Epic("Vat Return Module")
    @Feature("Verifying delete option ")
    @Severity(SeverityLevel.CRITICAL)
    public void Verifying_delete_option() {
        ...
        WebElement dropdown = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div/div/div/div[1]/div/div/div[7]/div/div[3]/div/button")));
        dropdown.click();
        Allure.step("dropdown clicked  successfully");
