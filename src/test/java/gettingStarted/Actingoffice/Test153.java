...
public class Test153 {
    ...
    @Test(description = "Search for Reimbursement user under Expense Claims")
    @Epic("Bookkeeping")
    @Feature("Expense Claims")
    @Story("Search Reimbursements by User")
    @Severity(SeverityLevel.MINOR)
    public void SearchReimbursement_Test() {
        ...
        WebElement searchBox = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div[1]/div[2]/div[1]/input")));
        searchBox.click();
        searchBox.sendKeys("testuser");
        searchBox.sendKeys(Keys.ENTER);
        Allure.step("Searched for user 'testuser' in reimbursements");
    }
...
//
//        WebElement search = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div[1]/div[2]/div[1]/input")));
//        search.click();
