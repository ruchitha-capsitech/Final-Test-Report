...
public class Test57 {
    ...
    @Test(description = "Date range filter Test")
    @Epic("Purchases")
    @Feature("Date range")
    @Story("Select from & to dates as per requirement")
    @Severity(SeverityLevel.NORMAL)
    public void Date_Range_Test() {
        ...
        Allure.step("Purchases section opened");

        WebElement elementFrom = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[2]/div[1]/div[2]/div[2]/div/div/div/div/input")));
        elementFrom.click();
        elementFrom.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        elementFrom.sendKeys("01/02/2025");
        Allure.step("Entered 'From' date: 01/02/2024");

        WebElement elementTo = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[2]/div[1]/div[2]/div[3]/div/div/div/div/input")));
        elementTo.click();
        elementTo.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        elementTo.sendKeys("27/10/2025");
        Allure.step("Entered 'To' date: 27/10/2026");

        WebElement refresh = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[2]/div[1]/div[2]/button[2]/span")));
        refresh.click();
        Allure.step("Clicked Refresh - data will be displayed for the selected date range");
    }
...
//        elementPurchase.click();
//
//        WebElement elementFrom = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[2]/div[1]/div[2]/div[2]/div/div/div/div/input")));
//        elementFrom.click();
//        elementFrom.sendKeys(Keys.chord(Keys.CONTROL, "a"));
//        elementFrom.sendKeys("01/02/2025");
//
//        WebElement elementTo = wait.until(ExpectedConditions.elementToBeClickable( By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[2]/div[1]/div[2]/div[3]/div/div/div/div/input")));
//        elementTo.click();
//        elementTo.sendKeys(Keys.chord(Keys.CONTROL, "a"));
//        elementTo.sendKeys("27/10/2025");
//
...
//        ));
//        refresh.click();
//            String path = "screenshots/test57.png";
...
////                "",
////                "",
////                "Data will be displayed based on the selected date range across all sections of the Purchase module.",
////                "verified",
////                "",
////                "Tested",
////                ""
