...
public class Test145 {
    ...
    @Test(description = "Adjusting vat values")
    @Epic("Vat Return Module")
    @Feature("Adjusting vat values")
    @Severity(SeverityLevel.CRITICAL)
    public void Adjusting_vat_values() {
        ...
        WebElement adjust = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/form/div/div[2]/div/div/div[2]/table/tbody/tr[1]/td[4]/button")));
        adjust.click();
        Allure.step("adjust button clicked  successfully");

        WebElement amount = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/div/form/div/div/div/div[2]/div/div/div/div/input")));
        amount.click();
        amount.sendKeys("1000");
        Allure.step("amount adjusted  successfully");

        WebElement adjust1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[3]/div/div/div/div[2]/div/div/button[2]")));
        adjust1.click();
        Allure.step("adjust button clicked  successfully");
