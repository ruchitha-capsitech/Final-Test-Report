...
public class Test98 {
    ...
    @Test(description = "Mileage Claim - Mileage number is mandatory")
    @Epic("Expense Claims")
    @Feature("Mileage Claims")
    @Story("User tries to save mileage claim after removing mileage number")
    @Severity(SeverityLevel.CRITICAL)
    public void ExpenseClaims_MileageNumberMandatory_Test() {
        driver.navigate().to("https://accountsuat.actingoffice.com/login?returnUrl=%2Foauth%2Fauthorize%2Fcallback%3Fclient_id%3Dweb%26redirect_uri%3Dhttps%253A%252F%252Fappuat.actingoffice.com%252Foidc-callback%26scope%3Dopenid%2520profile%2520offline_access%2520api%26response_type%3Dcode%26tenant%3Dappuat.actingoffice.com");
        ...
        WebElement elementCompany = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[3]/div/div/div[2]/div/div/div/div/div[3]/div[7]/div/div/div[3]/div/a")));
        ...
        user.click();
        Allure.step("Selected user: John Weaving");

        WebElement mileageno = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[1]/div[1]/div/div[2]/div[1]/div[1]/div/div/div/input")));
        mileageno.click();
        mileageno.clear();
        Allure.step("Cleared mileage number field (mandatory field)");
        ...
        WebElement Enginetype = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[3]/table/tbody/tr/td[2]/div/div/div/div[1]/div[2]/input")));
        Enginetype.click();
        WebElement option = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='Up to 1400cc']")));
        option.click();
        Allure.step("Selected engine type: Up to 1400cc");

        WebElement description = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[3]/table/tbody/tr/td[3]/div/div/div/input")));
        description.click();
        description.sendKeys("testing description");
        Allure.step("Entered description");

        WebElement mileage = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[3]/table/tbody/tr/td[4]/div/div/div/input")));
        mileage.click();
        mileage.sendKeys("5");
        Allure.step("Entered mileage: 5");

        WebElement save = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[4]/div[2]/div[3]/button[2]")));
        save.click();
        Allure.step("Clicked Save button - validation should prevent saving without mileage number");
    }
...
//            user.click();
//
//            WebElement mileageno = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[1]/div[1]/div/div[2]/div[1]/div[1]/div/div/div/input")));
//            mileageno.click();
//            mileageno.clear()  ;
//
...
//            option.click();
//
//            WebElement description = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[3]/table/tbody/tr/td[3]/div/div/div/input")));
//            description.click();
//            description.sendKeys("testing description");
//
...
//                "Expense claims/Mileage claims",
//                "Create mileage",
//                "",
//                "Click on \"Add Mileage,\" enter all the details, remove the mileage number, and then click on \"Save.\"",
//                "The mileage number is generated automatically by the system, and the entry cannot be saved without it. This is a mandatory field.",
//                "verified in uat",
//                "",
//                "Tested",
//                ""
