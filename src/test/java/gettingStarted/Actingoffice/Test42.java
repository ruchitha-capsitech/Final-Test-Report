...
public class Test42 {
    ...
    @Test(description = "Create Purchase Invoice with Discount Greater than Net Amount Test")
    @Epic("Purchases")
    @Feature("Purchase Invoice")
    @Severity(SeverityLevel.CRITICAL)
    public void Create_Purchase_Invoice_DiscountGreaterThanNet_Test() {
        ...
        WebElement discountType = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div/div[3]/div[2]/form/div/div[2]/div[2]/div/div[1]/div/div")));
        discountType.click();
        Allure.step("Discount type dropdown clicked");

        WebElement currencyOption = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//div[contains(@class,'rs-option') and normalize-space()='£']")));
        currencyOption.click();
        Allure.step("Discount type selected as £");

        WebElement discountAmount = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div/div[3]/div[2]/form/div/div[2]/div[2]/div/div[2]/div/div/input")));
        discountAmount.sendKeys("10000");
        Allure.step("Discount amount (greater than net) entered");

        WebElement saveButton1 = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div/div[4]/button[3]")));
        saveButton1.click();
        Allure.step("Save button clicked (first step)");
        ...
        saveButton2.click();
        Allure.step("Save button clicked (final step)");

        // Business expectation
        Allure.step("❌ Validation message shown: Discount greater than net amount not allowed, invoice not saved");
    }
...
//        ));
//        discount.click();
//            test.pass("discount button clicked  successfully");
...
//            test.pass("discount amount entered  successfully");
//        WebElement saveButton1 = wait.until(ExpectedConditions.elementToBeClickable(
//                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div/div[4]/button[3]")
//        ));
//        saveButton1.click();
...
//        saveButton.click();
//            test.pass("save button clicked  successfully");
//            String path = "screenshots/test42.png";
...
////                "Enter discount greater than net amount",
////                "Create a purchase invoice, enter a discount amount greater than the net amount, and click 'Save'.",
////                "System will give validation & don't save it",
////                "verified",
////                "",
////                "Tested",
////                ""
