...
public class Test144 {
    ...
    @Test(description = "Importing vat data")
    @Epic("Vat Return Module")
    @Feature("Importing vat data")
    @Severity(SeverityLevel.CRITICAL)
    public void Importing_vat_data() {
        ...
        WebElement importvat = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[1]/button")));
        importvat.click();
        Allure.step("import vat button clicked  successfully");
