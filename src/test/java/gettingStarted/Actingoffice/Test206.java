...
public class Test206 {
    ...
    @Test(description = "Open Customer Balances report (Test206)")
    @Epic("Bookkeeping")
    @Feature("Reports")
    @Story("Open Customer Balances report")
    @Severity(SeverityLevel.CRITICAL)
    public void openCustomerBalancesReport() {
        ...
        Allure.step("Click Customer Balances report", () -> {
            WebElement customerBalances = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[2]/div/div/div[3]")));
            customerBalances.click();
        });
    }
...
//        reports.click();
//
//        WebElement Customerbalances = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[2]/div/div/div[3]")));
//        Customerbalances.click();
//    }}