...
public class Test73 {
    ...
    @Test(description = "Add a new Journal and cancel it")
    @Epic("Journals")
    @Feature("Add Journal")
    @Story("Create Journal and cancel without saving")
    @Severity(SeverityLevel.NORMAL)
    public void Journals_AddAndCancel_Test() {
        ...
        WebElement cancel = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//*[@id=\"root\"]/div/div/div[2]/div[2]/div/div[2]/div[2]/form/div/div[3]/table/tbody/tr[6]/td[1]/div/button[1]")));
        cancel.click();
        ...
        yes.click();
        Allure.step("Confirmed cancellation, returned to Journal dashboard");
    }
...
//                "Add a new Journal",
//                "",
//                "Click on add + Journal, Date and voucher number will come auto, enter Journal reference,  Select account, Enter description if any, select VAT rate if any from dropdown, and enter amount in the respective boxes. Now click on cancel if you donnot wish to save it.",
//                "You will be Journal dashboard by clicks on cancel button.",
//                "verified",
//                "",
//                "Tested",
//                ""
