...
public class Test17 {
    ...
    @Test(description = "Deleting sales invoice")
    @Epic("Sales Module")
    @Feature("Deleting sales invoice")
    @Severity(SeverityLevel.CRITICAL)
    public void Deletingsalesinvoice() {
        ...
        WebElement elementDel = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[3]/div/div/ul/li[3]/button/div")));
        elementDel.click();
        Allure.step("delete button clicked  successfully");
        WebElement elementYes = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/div[2]/button[2]")));
        elementYes.click();
...
//            String path = "screenshots/test17.png";
...
////                "Delete that invoice",
////                "Next invoice sequence should be auto update accordingly",
