...
public class Test178 {
    ...
    @Test(description = "Delete a user Test 178")
    @Epic("Bookkeeping")
    @Feature("Users")
    @Story("Delete User")
    @Issue("the delete icon is not disabled when try to delete user with existing expenses it shows \"You cannot delete this user because it has linked transaction(s) message\"")
    @Severity(SeverityLevel.CRITICAL)
    public void deleteUserTest178() {
        ...
        Allure.step("Click Delete button for a user", () -> {
            WebElement delete = wait.until(ExpectedConditions.visibilityOfElementLocated(
                    By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[2]/div/div/div[2]/div/div/div/div/div/div[5]/div/div/div[4]/div/div[2]/div/button")
            ));
            delete.click();
        });

        Allure.step("Confirm deletion by clicking Yes", () -> {
