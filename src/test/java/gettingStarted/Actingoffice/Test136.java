...
public class Test136 {
    ...
    @Test(description = "Open Banking Logs")
    @Epic("Banking")
    @Feature("Logs")
    @Story("Navigate to banking logs from company")
    @Severity(SeverityLevel.NORMAL)
    public void OpenLogs_Test() {
        ...
        WebElement logs = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div[3]/button")));
        logs.click();
        Allure.step("Logs opened");
    }
...
//
//        WebElement logs = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div[3]/button")));
//        logs.click();
//    }}