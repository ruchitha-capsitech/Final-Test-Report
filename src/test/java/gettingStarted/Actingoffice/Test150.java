...
public class Test150 {
    ...
    @Test(description = "Create Reimbursement without amount under Expense Claims")
    @Epic("Bookkeeping")
    @Feature("Expense Claims")
    @Issue("Save button is diasbled but expenses list is shown")
    @Story("Reimbursement Creation without Amount")
    @Severity(SeverityLevel.CRITICAL)
    public void ReimbursementWithoutAmount_Test() {
        ...
        // Amount input intentionally skipped here
        Allure.step("Skipped entering reimbursement amount to test validation");
...
//        saveButton.click();
//        Allure.step("Clicked save button without entering amount");
    }
