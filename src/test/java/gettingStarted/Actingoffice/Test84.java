...
public class Test84 {
    ...
    @Test(description = "Import transactions and redirect to Cashcoding")
    @Epic("Banking")
    @Feature("Import CSV")
    @Story("Upload CSV and view imported transactions in Cashcoding")
    @Severity(SeverityLevel.CRITICAL)
    public void Banking_ImportTransactions_Cashcoding_Test() {
...
//        ignore.click();
//        Allure.step("Clicked 'Ignore' warning, redirected to Cashcoding screen");
    }
...
//                "The system will redirect to the Cashcoding screen, where all imported transactions will be displayed.",
//                "verified",
//                "",
//                "Tested",
//                ""
