...
public class Test16 {
    ...
    @Test(description = "Creating credit note by changing refund amount")
    @Epic("Sales Module")
    @Feature("estimates Creation")
    @Severity(SeverityLevel.CRITICAL)
    public void Creatingcreditnotebychangingrefundamount() {
        ...
        Allure.step("refund amount changed  successfully");
