...
public class Test53 {
    ...
    @Test(description = "Add Supplier Test")
    @Epic("Purchases")
    @Feature("Suppliers")
    ...
    public void Add_Supplier_Test() {
        ...
        WebElement elementSuppliers = wait.until(ExpectedConditions.elementToBeClickable(By.name("Suppliers")));
        elementSuppliers.click();
        Allure.step("Suppliers section opened");

        WebElement elementSupplier = wait.until(ExpectedConditions.elementToBeClickable(By.name("Supplier")));
        elementSupplier.click();
        Allure.step("Clicked on Add Supplier");
        ...
        Name.click();
        Name.sendKeys("A LIMITED1");
        Allure.step("Entered Supplier name");

        WebElement saveButton = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//button[.//span[text()='Save']]")));
        saveButton.click();
        Allure.step("Supplier saved successfully - will appear during invoice creation");
    }
...
//        test = extent.createTest("Adding Supplier Test");
//        try {
//        driver.navigate().to("https://accountsdev.actingoffice.com/login?returnUrl=%2Foauth%2Fauthorize%2Fcallback%3Fclient_id%3Dweb%26redirect_uri%3Dhttps%253A%252F%252Fappdev.actingoffice.com%252Foidc-callback%26scope%3Dopenid%2520profile%2520offline_access%2520api%26response_type%3Dcode%26tenant%3Dappdev.actingoffice.com%26acr_values%3Dtenant%253Aappdev.actingoffice.com%26state%3DVFtee6Ln1BghAWA7%26nonce%3DBxbxpUwmWRNI%26code_challenge%3D14dXypLaO1DS6oEkdmu0MfgAuUeFfDTOdgk6zE5mS-Q%26code_challenge_method%3DS256");
...
//        ));
//        saveButton.click();
//            String path = "screenshots/test53.png";
...
////                "Adding Supplier",
////                "",
////                "Click on the 'Add' button, enter all the required details, and then click 'Save'.",
////                "The supplier will be added to the system and will appear with all relevant details during invoice creation.",
////                "verified",
////                "",
////                "Tested",
////                ""
