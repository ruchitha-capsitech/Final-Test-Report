...
public class Test93 {
    ...
    @Test(description = "Expense Claims Creation & Amount Validation Test")
    @Epic("Expense Claims")
    @Feature("Create Expense")
    @Story("User creates an expense claim and verifies amount & due balance calculations")
    ...
    public void ExpenseClaims_CreateExpense_Test() {
        ...
        Allure.step("Clicked Add Expense");
        ...
        desiredOption.click();
        Allure.step("Selected Account: Opening stock - 2/1");
        ...
        Allure.step("Entered Amount: £600.00");
        ...
        saveBtn1.click();
        Allure.step("Clicked Save to create Expense Claim");
    }
