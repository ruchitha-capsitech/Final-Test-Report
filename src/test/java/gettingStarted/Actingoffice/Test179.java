...
public class Test179 {
    ...
    @Test(description = "Filter users by Deleted and Active status")
    @Epic("Bookkeeping")
    @Feature("Users")
    @Story("Filter User Status")
    @Severity(SeverityLevel.NORMAL)
    public void filterUsersTest179() {
        ...
        Allure.step("Filter users to Deleted", () -> {
            WebElement elementFilter = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[1]/div[2]/div/div[2]/div/div/div/div[2]/div")));
            elementFilter.click();
        ...
        Allure.step("Filter users to Active", () -> {
            WebElement elementFilter1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[1]/div[2]/div/div[2]/div/div/div/div[2]/div")));
