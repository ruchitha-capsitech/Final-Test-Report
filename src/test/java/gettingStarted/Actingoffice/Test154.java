...
public class Test154 {
    ...
    @Test(description = "Filter Reimbursements by Date Range")
    @Epic("Bookkeeping")
    @Feature("Expense Claims")
    @Story("Reimbursements Date Filter")
    @Severity(SeverityLevel.CRITICAL)
    public void FilterReimbursementsByDate_Test() {
        ...
        WebElement reimbursementTab = wait.until(ExpectedConditions.elementToBeClickable(By.name("Reimbursements")));
        reimbursementTab.click();
        Allure.step("Reimbursements tab opened");
        ...
        fromDate.sendKeys("01/02/2024");
        Allure.step("From date set to 01/02/2024");
        ...
        toDate.sendKeys("28/11/2025");
        Allure.step("To date set to 28/11/2025");
        ...
        refreshBtn.click();
        Allure.step("Filter applied with refresh button");
    }
