...
public class Test78 {
    ...
    @Test(description = "Edit a journal entry")
    @Epic("Journals")
    @Feature("Edit Journal")
    @Story("Edit an existing journal entry and save the changes")
    @Severity(SeverityLevel.CRITICAL)
    public void Journal_Edit_Test() {
        ...
        edit.click();
        Allure.step("Clicked Edit button on journal entry");
        ...
        elementJournalReference.clear();
        elementJournalReference.sendKeys("test1");
        Allure.step("Updated journal reference");
        ...
        save.click();
        Allure.step("Clicked Save button to apply changes");
    }
...
//                "Edit journal",
//                "",
//                "Click the 'Edit' button to make changes, then click 'Save' to apply them.",
//                "The journal entry will be saved with the applied changes.",
//                "verified",
//                "",
//                "Tested",
//                ""
