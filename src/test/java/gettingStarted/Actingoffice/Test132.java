...
public class Test132 {
    ...
    @Test(description = "Unexplain Transactions")
    @Epic("Banking")
    @Feature("Transaction Management")
    @Story("Unexplain transactions for selected account")
    @Severity(SeverityLevel.CRITICAL)
    public void UnexplainTransaction_Test() {
        ...
        WebElement explained = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[3]/div[1]/button[1]")));
        explained.click();
        Allure.step("Explained transactions opened");

        WebElement selectall = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[3]/div[2]/div/div/div/div/div[2]/div[1]/div/div/div[1]/div/div/label/div/i")));
        selectall.click();
        Allure.step("Selected all transactions");

        WebElement unexplain = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[2]/div/button[2]")));
        unexplain.click();
        Allure.step("Clicked Unexplain");
        ...
        yes.click();
        Allure.step("Confirmed unexplain action");
    }
...
//        account.click();
//
//        WebElement explained = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[3]/div[1]/button[1]")));
//        explained.click();
//
//        WebElement selectall = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[3]/div[2]/div/div/div/div/div[2]/div[1]/div/div/div[1]/div/div/label/div/i")));
//        selectall.click();
//
//        WebElement unexplain = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[2]/div/button[2]")));
//        unexplain.click();
//
