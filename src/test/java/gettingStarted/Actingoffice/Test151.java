...
public class Test151 {
    ...
    @Test(description = "Create Auto Reimbursement with User under Expense Claims")
    @Epic("Bookkeeping")
    @Feature("Expense Claims")
    @Story("Reimbursement Creation with Auto Distribution")
    @Severity(SeverityLevel.CRITICAL)
    public void AutoReimbursement_Test() {
        ...
        WebElement addReimbursement = wait.until(ExpectedConditions.elementToBeClickable(By.name("Reimbursement")));
        addReimbursement.click();
        Allure.step("Add Reimbursement clicked");
        ...
        user.click();
        Allure.step("User 'Testuser' selected");

        WebElement autoBtn = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div/div[3]/form/div/div[1]/div[2]/div[2]/div/div/button")));
        autoBtn.click();
        Allure.step("Clicked 'Auto' button");
        ...
        amountInput.sendKeys("£300.00");
        Allure.step("Entered reimbursement amount: £300.00");
        ...
        desiredOption.click();
        Allure.step("Account 'Cash in hand - 157/1' selected");

        WebElement amountInput1 = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div/div[3]/form/div/table/tbody/tr[1]/td[7]/div/div/div/input")));
        amountInput1.click();
        amountInput1.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        amountInput1.sendKeys("£300.00");
        Allure.step("Distributed reimbursement amount in table: £300.00");

        WebElement saveButton = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div/div[3]/form/div/div[2]/div[2]/div[2]/div[3]/button[2]")));
        saveButton.click();
        Allure.step("Reimbursement saved");
    }
