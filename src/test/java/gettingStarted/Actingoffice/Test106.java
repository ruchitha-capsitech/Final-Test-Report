...
public class Test106 {
    ...
    @Test(description = "Clone Mileage Claim Test")
    @Epic("Expense Claims")
    @Feature("Mileage Claim Cloning")
    @Story("User clones an existing mileage claim and saves it")
    @Severity(SeverityLevel.CRITICAL)
    public void MileageClaims_Clone_Test() {
        driver.navigate().to("https://accountsuat.actingoffice.com/login?returnUrl=%2Foauth%2Fauthorize%2Fcallback%3Fclient_id%3Dweb%26redirect_uri%3Dhttps%253A%252F%252Fappuat.actingoffice.com%252Foidc-callback");
        ...
        WebElement dropdown = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div/div[2]/div/div/div[2]/div/div/div/div/div/div/div/div/div[8]/div/div[3]/div/button")));
        dropdown.click();
        Allure.step("Opened options dropdown for the mileage claim");

        WebElement clone = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[3]/div/div/ul/li/button")));
        clone.click();
        Allure.step("Clicked Clone button");
        ...
        save.click();
        Allure.step("Saved cloned mileage claim");

//        WebElement skip = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[3]/div[2]/div[2]/button[2]")));
//        skip.click();
//        Allure.step("Skipped additional confirmation dialog");
    }
