...
public class Test19 {
    ...
    @Test(description = "Importing sales invoice with unmapped data")
    @Epic("Sales Module")
    @Feature("Importing sales invoice with unmapped data")
    @Severity(SeverityLevel.CRITICAL)
    public void Importingsalesinvoicewithunmappeddata() {
        ...
        elementUpload.click();
        Allure.step("Upload button clicked  successfully");
        ...
        Allure.step("ImportFile button clicked  successfully");
...
//            String path = "screenshots/test19.png";
...
////                "",
////                "Upload file then click on import, remain any column unmapped in which there is data",
////                "System will give validation & will not import data",
////                "System is giving validation & is not importing data",
////                "",
////                "Tested",
////                ""
////        );
