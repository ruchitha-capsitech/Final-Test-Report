...
public class Test54 {
    ...
    @Test(description = "Add Item Test")
    @Epic("Purchases")
    @Feature("Items")
    ...
    public void Add_Item_Test() {
        ...
        Allure.step("Clicked on Add Item");
        ...
        Name.click();
        Name.sendKeys("Lifetime");
        Allure.step("Entered Item name");

        WebElement CreateButton = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//button[.//span[text()='Create']]")));
        CreateButton.click();
        Allure.step("Item saved successfully - will appear during invoice creation");
    }
...
//        test = extent.createTest("Adding item Test");
//        try {
//        driver.navigate().to("https://accountsdev.actingoffice.com/login?returnUrl=%2Foauth%2Fauthorize%2Fcallback%3Fclient_id%3Dweb%26redirect_uri%3Dhttps%253A%252F%252Fappdev.actingoffice.com%252Foidc-callback%26scope%3Dopenid%2520profile%2520offline_access%2520api%26response_type%3Dcode%26tenant%3Dappdev.actingoffice.com%26acr_values%3Dtenant%253Aappdev.actingoffice.com%26state%3DVFtee6Ln1BghAWA7%26nonce%3DBxbxpUwmWRNI%26code_challenge%3D14dXypLaO1DS6oEkdmu0MfgAuUeFfDTOdgk6zE5mS-Q%26code_challenge_method%3DS256");
...
//        ));
//        CreateButton.click();
//            String path = "screenshots/test54.png";
...
////                "Adding item",
////                "",
////                "Click on the 'Add' button, enter the item name, description, price, VAT. Reference number & the account name will be auto-fetched. Then click on 'Save' and tick the checkbox for the item you created.",
////                "The item will be created and will appear during invoice creation. Simply select the item, and other details such as description, account name, and VAT will be automatically fetched from the item master.",
////                "Item is getting created but not appear during invoice creation",
////                "",
////                "Tested",
////                ""
////        );
