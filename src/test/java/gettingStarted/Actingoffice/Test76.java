...
public class Test76 {
    ...
    @Test(description = "Adding a journal with automatic VAT fetch")
    @Epic("Journals")
    @Feature("Add Journal")
    @Story("Add a journal and verify VAT is fetched automatically")
    @Severity(SeverityLevel.CRITICAL)
    public void Journal_Add_Test() {
        ...
        desiredOption.click();
        Allure.step("Selected first account 'Sales - 1/1'");
        ...
        Allure.step("Entered amount 800.00 for first account");
        ...
        Allure.step("Selected second account 'Purchases - 3/1'");
        ...
        Allure.step("Entered amount 800.00 for second account");
        ...
        save.click();
        Allure.step("Clicked Save button - journal should be added and VAT fetched automatically");
    }
...
//                "Adding a journal",
//                "",
//                "When adding a journal with any account head, the system should automatically fetch the applicable VAT based on the selected account head. Click on 'Save' to complete the process.",
//                "The journal will be added to the dashboard with a unique reference number, and its impact will be reflected in the respective ledgers.",
//                "verified",
//                "",
//                "Tested",
//                ""
