...
public class Test81 {
    ...
    @Test(description = "Lock or Reverse journal")
    @Epic("Journals")
    @Feature("Reverse / Lock Journal")
    @Story("Click on reverse or lock button to restrict editing of system-generated journals")
    @Severity(SeverityLevel.CRITICAL)
    @Issue("They can be edited ")
    public void Journal_ReverseLock_Test() {
        ...
        WebElement reverse = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"btn-btnReverse\"]")));
        reverse.click();
        Allure.step("Clicked Reverse Journal button");

        WebElement save = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//*[@id=\"root\"]/div/div/div[2]/div[2]/div/div[2]/div[2]/form/div/div[3]/table/tbody/tr[6]/td[1]/div/button[2]")));
        save.click();
        Allure.step("Clicked Save button after reversal");

        WebElement edit = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"btn-btnEdit\"]")));
        edit.click();
        Allure.step("Clicked Edit button to verify journal locking behavior");
    }
...
//            reverse.click();
//
//            WebElement save = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"root\"]/div/div/div[2]/div[2]/div/div[2]/div[2]/form/div/div[3]/table/tbody/tr[6]/td[1]/div/button[2]")));
//            save.click();
//
//            WebElement edit = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"btn-btnEdit\"]")));
//            edit.click();
...
//                "Edit journal",
//                "",
//                "Click on reverse or lock button",
//                "System created journals will be locked & can't be edited ",
//                "They can be edited ",
//                "",
//                "Tested",
//                ""
