...
public class Test127 {
    ...
    @Test(description = "Explain Transaction with Account Head")
    @Epic("Banking")
    @Feature("Transaction Explanation")
    @Story("Assign account head and explain transaction")
    @Severity(SeverityLevel.CRITICAL)
    public void ExplainTransaction_Test() {
        ...
        option.click();
        Allure.step("Selected account head 'Sales - 1/1'");
        ...
        explainbtn.click();
        Allure.step("Clicked Explain button");
    }
