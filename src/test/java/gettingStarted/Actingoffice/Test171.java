...
public class Test171 {
    ...
    @Test(description = "Add a new User Test 171")
    @Epic("Bookkeeping")
    @Feature("Users")
    @Story("Add User")
    @Severity(SeverityLevel.CRITICAL)
    @Issue("Invalid entry test, date reset to. It is not showing any validation the user is getting succesfully saved ,but the user is not appearing in the user dashboard list.")
    public void addUserTest171() {
        ...
        Allure.step("Enter DOB", () -> {
            ...
            dob.click(); // click preserved
            dob.sendKeys("test"); // testing invalid date
        });
