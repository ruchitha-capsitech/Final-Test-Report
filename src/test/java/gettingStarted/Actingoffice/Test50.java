...
public class Test50 {
    ...
    @Test(description = "Create Purchase Order Test")
    @Epic("Purchases")
    @Feature("Purchase Orders")
    @Severity(SeverityLevel.CRITICAL)
    public void Create_PurchaseOrder_Test() {
        ...
        Allure.step("Add Purchase Order clicked");
        ...
        option.click();
        Allure.step("Item selected");

        WebElement saveButton = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//button[.//span[text()='Save']]")));
        saveButton.click();
        Allure.step("Purchase Order saved successfully");
    }
...
//        test = extent.createTest("Create purchase order Test");
//        try {
...
//        ));
//        saveButton.click();
//            String path = "screenshots/test50.png";
...
////                "",
////                "Click on the 'Add' button, select the supplier, choose the date, enter the item, quantity, and price, then click on 'Save'.",
////                "A purchase order will be created with reference no.",
////                "verified",
////                "",
////                "Tested",
////                ""
