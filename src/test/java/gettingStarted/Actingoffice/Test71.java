...
public class Test71 {
    ...
    @Test(description = "Add a new Journal and validate it is created successfully")
    @Epic("Journals")
    @Feature("Add Journal")
    @Story("User should be able to add a new journal with correct values")
    @Severity(SeverityLevel.CRITICAL)
    public void Journals_AddNewJournal_Test() {
        ...
        save.click();
        Allure.step("Journal saved successfully");
    }
...
//                "Add a new Journal",
//                "",
//                "Click on add + Journal, Date and voucher number will come auto, enter Journal reference,  Select account, Enter description if any, select VAT rate if any from dropdown, and enter amount in the respective boxes. Now click on Save.",
//                "Journal created and saved on Journal dashboard with reference number",
//                "verified",
//                "",
//                "Tested",
//                ""
