...
public class Test52 {
    ...
    @Test(description = "Make Payment Test")
    @Epic("Purchases")
    @Feature("Payments")
    ...
    public void Make_Payment_Test() {
        ...
        Allure.step("Clicked on Add Payment");

        WebElement receivedFrom = wait.until(ExpectedConditions.visibilityOfElementLocated(
        ...
        amountInput.sendKeys("£200.00");
        Allure.step("Entered payment amount");
