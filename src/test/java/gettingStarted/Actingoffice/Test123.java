...
public class Test123 {
    ...
    @Test(description = "Split a banking transaction using Cash Coding")
    @Epic("Banking")
    @Feature("Transactions")
    @Story("Split transaction with multiple Money Out entries")
    @Severity(SeverityLevel.CRITICAL)
    public void SplitTransaction_Test() {
        ...
        WebElement account = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[2]/div/div/div/div[2]")));
        account.click();
        Allure.step("Account opened");

        WebElement cashcoding = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[1]/div[2]/button[2]")));
        cashcoding.click();
        Allure.step("Cash Coding section opened");

        WebElement dropdown = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[3]/div/div/div[3]/div[1]/div[2]/div/div[2]/div[2]/div/div/div/div[10]/div/div/div[1]/div/div/button")));
        dropdown.click();
        Allure.step("Dropdown opened for transaction options");

        WebElement split = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[2]/div/div/div/div/div[3]/div/div/ul/li[2]/button")));
        split.click();
        Allure.step("Split option selected");
        ...
        Allure.step("First Money Out amount entered: 300.00");

        WebElement vat = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[2]/div[2]/table/tbody/tr[1]/td[7]/div/div/div/div[2]/div")));
        vat.click();
        WebElement option = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='0%']")));
        option.click();
        Allure.step("First VAT option '0%' selected");
        ...
        Allure.step("Second Money Out amount entered: 200.00");

        WebElement vat1 = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[2]/div[2]/table/tbody/tr[2]/td[7]/div/div/div/div[2]/div")));
        vat1.click();
        WebElement option1 = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='0%']")));
        option1.click();
        Allure.step("Second VAT option '0%' selected");

        WebElement account1 = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[2]/div[2]/table/tbody/tr/td[6]/div/div/div/div[2]/div")));
        account1.click();
        WebElement accountoption1 = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='Sales - 1/1']")));
        accountoption1.click();


        WebElement account2 = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[2]/div[2]/table/tbody/tr[2]/td[6]/div/div/div/div[2]/div")));
        account2.click();
        WebElement accountoption2 = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='Sales - 1/1']")));
        accountoption2.click();




        WebElement splitbtn = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[4]/div[2]/button[2]")));
        splitbtn.click();
        Allure.step("Split button clicked");
//
...
//        save.click();
        Allure.step("Transaction saved after split");
    }
