...
public class Test197 {
    ...
    @Test(description = "Add Fixed Asset with Date, Account, Supplier, Description, Amount, and Rate (Test197)")
    @Epic("Bookkeeping")
    @Feature("Assets")
    @Story("Add Fixed Asset with Date and Rate")
    @Severity(SeverityLevel.CRITICAL)
    public void addFixedAssetWithDateAndRate() {
        ...
        Allure.step("Clear Date field", () -> {
            ...
            ddate.sendKeys(Keys.DELETE);
        });

        Allure.step("Enter asset details: Name, Account, Supplier, Description, Amount, Rate", () -> {
