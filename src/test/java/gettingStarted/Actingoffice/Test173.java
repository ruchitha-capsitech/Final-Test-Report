...
public class Test173 {
    ...
    @Test(description = "Edit user's email Test 173")
    @Epic("Bookkeeping")
    @Feature("Users")
    @Story("Edit User Email")
    @Severity(SeverityLevel.CRITICAL)
    public void editUserEmailTest173() {
        ...
        Allure.step("Update Email field", () -> {
            ...
            email.clear();
            email.sendKeys("testing1-user@gmail.com");
        });
