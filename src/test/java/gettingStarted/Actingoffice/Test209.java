...
public class Test209 {
    ...
    @Test(description = "Set depreciation date and refresh in Assets module (Test209)")
    @Epic("Bookkeeping")
    @Feature("Assets")
    @Story("Depreciations with custom date filter")
    @Severity(SeverityLevel.NORMAL)
    public void depreciationDateAndRefresh() {
        ...
        Allure.step("Enter depreciation date", () -> {
            WebElement date = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[1]/div[2]/div[2]/div/div/div/div/input")));
            date.click();
        ...
        Allure.step("Click Refresh button", () -> {
            WebElement refresh = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div/div/div[1]/div[2]/button/span")));
            refresh.click();
        });
    }
