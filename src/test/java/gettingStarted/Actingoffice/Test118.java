...
public class Test118 {
    ...
    @Test(description = "Transfer banking transaction to another account")
    @Epic("Banking")
    @Feature("Transactions")
    @Story("Transfer transaction between accounts")
    @Severity(SeverityLevel.CRITICAL)
    public void TransferTransaction_Test() {
        ...
        WebElement transfer = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[3]/div[2]/div/div/div/div/div[2]/div[2]/div[2]/div/div/div[1]/button[3]")));
        transfer.click();
        Allure.step("Transfer option selected");

        WebElement account1 = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[3]/div[2]/div/div/div/div/div[2]/div[2]/div[2]/div/div/div[3]/div/div/div[1]/div[1]/div/div/div/div[1]/div[2]/input")));
        account1.click();

        Allure.step("Destination account dropdown clicked");

        account1.sendKeys(Keys.ENTER);
        Allure.step("Destination account selected");

        WebElement transferbtn = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[3]/div[2]/div/div/div/div/div[2]/div[2]/div[2]/div/div/div[3]/div/div/div[2]/div/button[2]")));
        transferbtn.click();
        Allure.step("Transfer completed");
    }
...
//        transaction.click();
//
//        WebElement transfer = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[3]/div[2]/div/div/div/div/div[2]/div[2]/div[2]/div/div/div[1]/button[3]")));
//        transfer.click();
//
//        WebElement account1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[3]/div[2]/div/div/div/div/div[2]/div[2]/div[2]/div/div/div[3]/div/div/div[1]/div[1]/div/div/div/div[1]/div[2]/input")));
//        account1.click();
//        WebElement option = wait.until(ExpectedConditions.visibilityOfElementLocated(
//                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='Cater Allen - Current (5432)']")
//        ));
//        option.click();
//
//
//        WebElement transferbtn = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div/div[3]/div/div/div[3]/div[2]/div/div/div/div/div[2]/div[2]/div[2]/div/div/div[3]/div/div/div[2]/div/button[2]")));
//        transferbtn.click();
//    }}