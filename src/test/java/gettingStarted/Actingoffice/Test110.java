...
public class Test110 {
    ...
    @Test(description = "Navigate to Mileage Claims page")
    @Epic("Expense Claims")
    @Feature("Mileage Claims Navigation")
    @Story("User navigates through Admin > Bookkeeping > Company > Inputs > Expense Claims > Mileage Claims")
    @Severity(SeverityLevel.NORMAL)
    public void MileageClaims_Navigation_Test() {
