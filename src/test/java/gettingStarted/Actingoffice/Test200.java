...
public class Test200 {
    ...
    @Test(description = "Open General Ledger Detailed Report (Test200)")
    @Epic("Bookkeeping")
    @Feature("Reports")
    @Story("Access General Ledger Detailed Report")
    @Severity(SeverityLevel.CRITICAL)
    public void openGeneralLedgerDetailedReport() {
        ...
        Allure.step("Select Detailed option", () -> {
            WebElement detailed = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[4]/label/div")));
            detailed.click();
        });
    }
...
//        generalledger.click();
//
//        WebElement detailed = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[4]/label/div")));
//        detailed.click();
//    }}