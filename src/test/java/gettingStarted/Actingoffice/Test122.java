...
public class Test122 {
    ...
    @Test(description = "Explain a banking transaction with account head selection")
    @Epic("Banking")
    @Feature("Transactions")
    @Story("Explain transaction by selecting account head")
    @Severity(SeverityLevel.BLOCKER)
    public void ExplainTransactionWithAccountHead_Test() {
        ...
        accounthead.click();
        Allure.step("Account head dropdown opened");

        WebElement option = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//*[contains(@class, 'rs-option') and normalize-space(text())='Sales - 1/1']")));
        option.click();
        Allure.step("Account head 'Sales - 1/1' selected");
        ...
        explainbtn.click();
        Allure.step("Explain button clicked for transaction");
    }
