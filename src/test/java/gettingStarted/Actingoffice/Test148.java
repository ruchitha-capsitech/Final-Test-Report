...
public class Test148 {
    ...
    @Test(description = "Create Reimbursement with Date cleared under Expense Claims")
    @Epic("Bookkeeping")
    @Feature("Expense Claims")
    @Story("Reimbursement Creation with Date Handling")
    @Severity(SeverityLevel.CRITICAL)
    public void ReimbursementWithDate_Test() {
        ...
        WebElement date = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div/div[2]/div/div[3]/form/div/div[1]/div[1]/div[1]/div[3]/div/div/div/div/div/input")
        ));
        date.sendKeys(Keys.chord(Keys.CONTROL, "a"));
        date.sendKeys(Keys.DELETE);
        Allure.step("Date cleared");
