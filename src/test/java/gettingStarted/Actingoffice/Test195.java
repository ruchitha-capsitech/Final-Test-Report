...
public class Test195 {
    ...
    @Test(description = "Add Fixed Asset with Depreciation, VAT, Account, Supplier, and Amount (Test195)")
    @Epic("Bookkeeping")
    @Feature("Assets")
    @Story("Add Fixed Asset with Depreciation enabled")
    @Severity(SeverityLevel.CRITICAL)
    public void addFixedAssetWithDepreciation() {
        ...
        Allure.step("Enter asset details with Depreciation, VAT, Account, Supplier, Description, and Amount", () -> {
            ...
            WebElement depriciation = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[7]/div/div/div/button")));
            depriciation.click();

            WebElement vat = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[4]/div/div/div/div/div[1]/div[2]/input")));
            vat.click();
            WebElement desiredVAT = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("//div[contains(@class,'rs-option') and normalize-space()='0%']")));
            desiredVAT.click();
            ...
            WebElement desiredAccount = wait.until(ExpectedConditions.elementToBeClickable(
        ...
        Allure.step("Click Depreciations tab", () -> {
            WebElement depreciationTab = wait.until(ExpectedConditions.elementToBeClickable(By.name("Depreciations")));
            depreciationTab.click();
        });
    }
...
//        assetname.sendKeys("test");
//
//        WebElement depriciation = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[7]/div/div/div/button")));
//        depriciation.click();
//
//        WebElement vat = wait.until(ExpectedConditions.elementToBeClickable(
//                By.xpath("/html/body/div[2]/div/div/div/div/div[2]/div[2]/div/div[2]/form/div/div[4]/div/div/div/div/div[1]/div[2]/input")
...
//        save.click();
//
//        wait.until(ExpectedConditions.elementToBeClickable(By.name("Depreciations"))).click();
//
//    }}