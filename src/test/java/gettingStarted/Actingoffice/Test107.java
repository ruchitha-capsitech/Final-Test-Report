...
public class Test107 {
    ...
    @Test(description = "Delete Mileage Claim Test")
    @Epic("Expense Claims")
    @Feature("Mileage Claim Deletion")
    @Story("User deletes an existing mileage claim")
    @Severity(SeverityLevel.CRITICAL)
    public void MileageClaims_Delete_Test() {
        ...
        WebElement del = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div/div/div/div[3]/div/div/ul/li[2]/button")));
        del.click();
        Allure.step("Clicked Delete button");
        ...
        yes.click();
        Allure.step("Confirmed deletion");
    }
